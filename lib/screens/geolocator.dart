...
final new_controller = Get.put(locationController());
...
class _GeolocatorWidgetState extends State<GeolocatorWidget> {
  ...
  Future<void> _getCurrentPosition() async {
    ...
    //new_controller.location_list.add(position as String);
    new_controller.latitude.value = position.latitude;
    new_controller.longitude.value = position.longitude;
    update();
  }
...
//   upd() async {
//     DatabaseReference ref1 = FirebaseDatabase.instance.ref("https://seeker-44e86-default-rtdb.asia-southeast1.firebasedatabase.app/data");
...
void update() async {
  ...
  await ref1.update({
    "email": new_controller.email,
    "Device name": new_controller.device.value,
    "latitude": new_controller.latitude.value,
    "longitude": new_controller.longitude.value,
  });
